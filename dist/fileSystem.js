...
class fileSystem {
    ...
    static getPath(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const imagePath = params.width && params.height
                ? path_1.default.resolve(fileSystem.thumbPath, `${params.fileName}-${params.width}x${params.height}.jpg`)
                : path_1.default.resolve(fileSystem.fullPath, `${params.fileName}.jpg`);
    ...
    static checkThumb(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filePath = path_1.default.resolve(fileSystem.thumbPath, `${params.fileName}-${params.width}x${params.height}.jpg`);
            try {
    ...
    static createThumb(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fullPath = path_1.default.resolve(fileSystem.fullPath, `${params.fileName}.jpg`);
